    ...
    <View style={styles.container}>
      <View style={styles.head}>
        <View style={styles.backshare}>
          <Image source={require("../KiemTra/assets/iconBack.png")}></Image>
          <Image source={require("../KiemTra/assets/iconShare.png")}></Image>
        </View>
        <Image source={require("../KiemTra/assets/imgFlowers1.png")} style={[styles.img, { width: '100%', height: 420 }]} ></Image>
      ...
      <View style={styles.foot}>
        <View style={styles.title}>
          ...
          <Image style={styles.heart} source={require("../KiemTra/assets/like.png")}></Image>
        </View>
        <View>
        ...
        <View>
          <View style={styles.info}>
            <Image source={require("../KiemTra/assets/iconWallet.png")}></Image>
            <Text style={styles.text}>Reward 34$</Text>
          </View>
          <View style={styles.info}>
            <Image source={require("../KiemTra/assets/iconGeo.png")}></Image>
        ...
        <View style={styles.bottom}>
          <TouchableOpacity style={styles.chat}>
            <Image style={styles.chatbox} source={require("../KiemTra/assets/Icon_Chat.png")}></Image>
          </TouchableOpacity>
